...
PG_LWLOCK(54, DWBRingOpen)
PG_LWLOCK(55, DWBSegHash)
PG_LWLOCK(56, DWBSelfSweep)
PG_LWLOCK(57, DWBSyncfsRound)
PG_LWLOCK(58, DWBCleanerQueue)
PG_LWLOCK(59, ReplayWarmRead)
